import { RiCloseLine, RiDownloadLine, RiPriceTag3Line, RiSparkling2Line } from "@remixicon/react";
...
export function SettingsDialog({ isOpen, onClose, onOpenImport, onOpenTags, onOpenAi }: { isOpen: boolean; onClose: () => void; onOpenImport: () => void; onOpenTags: () => void; onOpenAi: () => void }) {
  return (
        ...
        <Dialog className="form-dialog">
          {({ close }) => <>
            ...
            <div className="settings-list">
              ...
              <div className="settings-row"><div><strong>AI 助手</strong><span>配置自己的 Provider、API Key 与模型。</span></div><Button size="sm" variant="secondary" onPress={() => { close(); onOpenAi(); }}><RiSparkling2Line size={15} />配置 AI</Button></div>
