import type { Channel, InspirationItem } from "@/src/domain/inspiration";

export const channels: Channel[] = [
  { id: "all", name: "全部", count: 21, color: "#090a0b", group: "网页" },
  { id: "skills", name: "skill", count: 9, color: "#838383", group: "网页" },
  { id: "design", name: "设计", count: 17, color: "#838383", group: "网页" },
  { id: "tools", name: "工具", count: 13, color: "#838383", group: "网页" },
  { id: "infra", name: "基建", count: 5, color: "#838383", group: "网页" },
  { id: "articles", name: "全部", count: 3, color: "#090a0b", group: "文章" },
  { id: "read", name: "已读", count: 0, color: "#838383", group: "文章" },
  { id: "unread", name: "未读", count: 3, color: "#838383", group: "文章" },
  { id: "creators", name: "博主", count: 5, color: "#838383", group: "关注" },
  { id: "blogs", name: "博客", count: 3, color: "#838383", group: "关注" },
  { id: "up", name: "UP主", count: 0, color: "#838383", group: "关注" },
];

type DemoItem = Omit<InspirationItem, "savedAt" | "aiStatus" | "cover"> & {
  coverImage?: string;
  coverLabel?: string;
  coverBackground?: string;
  coverForeground?: string;
  coverMotif?: InspirationItem["cover"]["motif"];
};

function createDemoItem(item: DemoItem): InspirationItem {
  const { coverImage, coverLabel, coverBackground, coverForeground, coverMotif, ...content } = item;
  return {
    ...content,
    savedAt: "演示导入",
    aiStatus: "complete",
    cover: {
      ...
      foreground: coverForeground ?? "#181512",
...
export const inspirationItems: InspirationItem[] = [
  createDemoItem({
    ...
    url: "https://remixicon.com/icon/arrow-right-up-line", channelIds: ["design", "tools", "skills"], tags: ["图标", "开源", "Remix Icon"],
    note: "卡片右上角跳转图标的来源。", siteIcon: "https://remixicon.com/favicon.ico",
  ...
  createDemoItem({
    ...
    url: "https://1wei.dev/", channelIds: ["design", "tools", "creators"], tags: ["个人网站", "开发者", "作品集"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://www.okuso.uk/", channelIds: ["design", "tools", "creators"], tags: ["个人网站", "全栈开发", "作品集"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://cali.so/", channelIds: ["design", "creators"], tags: ["设计工程", "个人网站", "创意总监"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://www.pseudoyu.com/posts", channelIds: ["articles", "unread", "blogs"], tags: ["博客", "技术写作", "生活"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://charlsyang.com/blog", channelIds: ["articles", "unread", "blogs", "creators"], tags: ["博客", "设计", "写作"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://www.nicoletang.design/", channelIds: ["design", "creators"], tags: ["作品集", "建筑", "排版"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://designengineer.tools/", channelIds: ["design", "tools", "skills"], tags: ["设计工程", "工具集", "资源导航"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://designspells.com/", channelIds: ["design", "skills"], tags: ["设计灵感", "微交互", "动效"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://motion-primitives.com/", channelIds: ["design", "tools", "skills"], tags: ["动效", "React", "组件库"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://bestdesignsonx.com/", channelIds: ["design"], tags: ["设计灵感", "视觉设计", "精选"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://ui.shadcn.com/", channelIds: ["design", "tools", "infra", "skills"], tags: ["设计系统", "React", "组件库"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://www.hextaui.com/", channelIds: ["design", "tools", "skills"], tags: ["shadcn/ui", "组件库", "区块"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://intentui.com/components", channelIds: ["design", "tools", "infra", "skills"], tags: ["React Aria", "可访问性", "组件库"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://www.originkit.dev/", channelIds: ["design", "tools", "skills"], tags: ["动画组件", "Framer", "MCP"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://astryx.atmeta.com/", channelIds: ["design", "tools", "infra"], tags: ["设计系统", "开源", "Agent"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://www.untitledui.com/", channelIds: ["design", "tools", "infra"], tags: ["Figma", "React", "UI Kit"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://www.beautifului.dev/", channelIds: ["design", "tools", "skills"], tags: ["AI 界面", "组件库", "交互"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://21st.dev/", channelIds: ["design", "tools", "infra", "skills"], tags: ["React", "Tailwind CSS", "组件社区"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://uibook.art/", channelIds: ["design"], tags: ["UI 灵感", "网页设计", "组件"], note: "",
  ...
  createDemoItem({
    ...
    url: "https://cuelume-site.pages.dev/#start", channelIds: ["design", "tools", "skills"], tags: ["交互声音", "Web Audio", "微交互"], note: "",
